...
public class CustomExceptionHandler {
	...
	@ExceptionHandler(value = OrganizationServiceBusinessException.class)
	public ResponseEntity<ErrorMessage> handleOrganizationServiceBusinessException(
			OrganizationServiceBusinessException exception, WebRequest webRequest) {
